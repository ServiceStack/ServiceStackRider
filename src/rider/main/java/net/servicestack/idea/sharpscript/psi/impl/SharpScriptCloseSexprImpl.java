...
public class SharpScriptCloseSexprImpl extends ASTWrapperPsiElement implements SharpScriptCloseSexpr {

  public SharpScriptCloseSexprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SharpScriptVisitor visitor) {
    visitor.visitCloseSexpr(this);
  }
