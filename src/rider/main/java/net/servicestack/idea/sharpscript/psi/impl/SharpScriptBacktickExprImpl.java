...
public class SharpScriptBacktickExprImpl extends ASTWrapperPsiElement implements SharpScriptBacktickExpr {

  public SharpScriptBacktickExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SharpScriptVisitor visitor) {
    visitor.visitBacktickExpr(this);
  }
