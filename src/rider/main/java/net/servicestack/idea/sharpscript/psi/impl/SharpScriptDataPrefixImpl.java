...
public class SharpScriptDataPrefixImpl extends ASTWrapperPsiElement implements SharpScriptDataPrefix {

  public SharpScriptDataPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SharpScriptVisitor visitor) {
    visitor.visitDataPrefix(this);
  }
