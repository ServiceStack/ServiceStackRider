...
public class SharpScriptOpenRawBlockImpl extends ASTWrapperPsiElement implements SharpScriptOpenRawBlock {

  public SharpScriptOpenRawBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SharpScriptVisitor visitor) {
    visitor.visitOpenRawBlock(this);
  }
