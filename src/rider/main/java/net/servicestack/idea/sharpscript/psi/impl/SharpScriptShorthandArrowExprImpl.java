...
public class SharpScriptShorthandArrowExprImpl extends ASTWrapperPsiElement implements SharpScriptShorthandArrowExpr {

  public SharpScriptShorthandArrowExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SharpScriptVisitor visitor) {
    visitor.visitShorthandArrowExpr(this);
  }
