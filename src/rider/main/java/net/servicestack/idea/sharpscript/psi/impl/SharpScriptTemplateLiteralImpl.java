...
public class SharpScriptTemplateLiteralImpl extends ASTWrapperPsiElement implements SharpScriptTemplateLiteral {

  public SharpScriptTemplateLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
