...
public class SharpScriptCloseBlockImpl extends ASTWrapperPsiElement implements SharpScriptCloseBlock {

  public SharpScriptCloseBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SharpScriptVisitor visitor) {
    visitor.visitCloseBlock(this);
  }
