...
public class SharpScriptJsLiteralImpl extends ASTWrapperPsiElement implements SharpScriptJsLiteral {

  public SharpScriptJsLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SharpScriptVisitor visitor) {
    visitor.visitJsLiteral(this);
  }
