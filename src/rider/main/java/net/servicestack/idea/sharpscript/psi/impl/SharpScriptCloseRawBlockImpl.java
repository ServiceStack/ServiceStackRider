...
public class SharpScriptCloseRawBlockImpl extends ASTWrapperPsiElement implements SharpScriptCloseRawBlock {

  public SharpScriptCloseRawBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SharpScriptVisitor visitor) {
    visitor.visitCloseRawBlock(this);
  }
