...
public class SharpScriptMethodNameImpl extends ASTWrapperPsiElement implements SharpScriptMethodName {

  public SharpScriptMethodNameImpl(@NotNull ASTNode node) {
    super(node);
  }
